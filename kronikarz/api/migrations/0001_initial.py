    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('father', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='person_father', to='api.person')),
                ('mother', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='person_mother', to='api.person')),
            ],
        ),
        migrations.CreateModel(
            name='Media',
